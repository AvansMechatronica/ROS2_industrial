...
def generate_launch_description():
    ...
    xacro_file = os.path.join(package_share_directory, 'urdf', 'assignment4.urdf.xacro')
    rviz_config_file = os.path.join(package_share_directory, 'rviz', 'assignment4.rviz')
