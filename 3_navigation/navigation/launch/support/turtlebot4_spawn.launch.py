...
def generate_launch_description():
    ...
    turtlebot4_ros_gz_bridge_launch = PathJoinSubstitution(
        [pkg_navigation, 'launch', 'support', 'ros_gz_bridge.launch.py'])
    rviz_launch = PathJoinSubstitution(
        [pkg_turtlebot4_viz, 'launch', 'view_navigation.launch.py'])
    turtlebot4_node_launch = PathJoinSubstitution(
        [pkg_navigation, 'launch', 'support', 'turtlebot4_nodes.launch.py'])
    ...
    param_file_cmd = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution(
            [pkg_navigation, 'config', 'turtlebot4_node.yaml']),
