...
{
  this->node_.Subscribe(this->display_topic_, &VacuumGripper::OnRawMessage, this);
  this->node_.Subscribe(this->display_selected_topic_, &VacuumGripper::OnSelectedMessage, this);
  this->node_.Subscribe(this->power_led_topic_, &VacuumGripper::OnPowerLedMessage, this);
  this->node_.Subscribe(this->motors_led_topic_, &VacuumGripper::OnMotorsLedMessage, this);
  this->node_.Subscribe(this->comms_led_topic_, &VacuumGripper::OnCommsLedMessage, this);
  this->node_.Subscribe(this->wifi_led_topic_, &VacuumGripper::OnWifiLedMessage, this);
  this->node_.Subscribe(this->battery_led_topic_, &VacuumGripper::OnBatteryLedMessage, this);
  this->node_.Subscribe(this->user1_led_topic_, &VacuumGripper::OnUser1LedMessage, this);
  this->node_.Subscribe(this->user2_led_topic_, &VacuumGripper::OnUser2LedMessage, this);
}
...
void VacuumGripper::LoadConfig(const tinyxml2::XMLElement * _pluginElem)
{
  if (!_pluginElem) {
    return;
  }
...
QString VacuumGripper::Namespace() const
{
  return QString::fromStdString(this->namespace_);
}

void VacuumGripper::SetNamespace(const QString &_name)
{
...
void VacuumGripper::OnHmiButton(const int button)
{
...
void VacuumGripper::OnCreate3Button(const int button)
{
  gz::msgs::Int32 button_msg;
...
void VacuumGripper::OnRawMessage(const gz::msgs::StringMsg & msg)
{
  std::lock_guard < std::mutex > lock(this->raw_msg_mutex_);
  this->AddMsg(QString::fromStdString(msg.data()));
}

void VacuumGripper::OnSelectedMessage(const gz::msgs::Int32 & msg)
{
  std::lock_guard < std::mutex > lock(this->selected_msg_mutex_);
  selected_line_ = msg.data();
}

void VacuumGripper::OnPowerLedMessage(const gz::msgs::Int32 & msg)
{
  switch (msg.data()) {
    case 0:
      {
...
void VacuumGripper::OnMotorsLedMessage(const gz::msgs::Int32 & msg)
{
  switch (msg.data()) {
    case 0:
      {
...
void VacuumGripper::OnCommsLedMessage(const gz::msgs::Int32 & msg)
{
  switch (msg.data()) {
    case 0:
      {
...
void VacuumGripper::OnWifiLedMessage(const gz::msgs::Int32 & msg)
{
  switch (msg.data()) {
    case 0:
      {
...
void VacuumGripper::OnBatteryLedMessage(const gz::msgs::Int32 & msg)
{
  switch (msg.data()) {
    case 0:
      {
...
void VacuumGripper::OnUser1LedMessage(const gz::msgs::Int32 & msg)
{
  switch (msg.data()) {
    case 0:
      {
...
void VacuumGripper::OnUser2LedMessage(const gz::msgs::Int32 & msg)
{
  switch (msg.data()) {
    case 0:
      {
...
void VacuumGripper::OnAddMsg(QString msg)
{
  std::lock_guard < std::mutex > lock(this->raw_msg_mutex_);
